...
export function QuestsIcon({ className, width = 40, height = 40 }: SVGIcons) {
	return (
		<svg
			version='1.1'
			id='Quests_Icon'
		...
		>
			<path
				d='M10,2.708l1.774,3.813l0.452,0.97l1.058,0.163l4.138,0.637l-3.07,3.175l-0.697,0.721l0.16,0.989l0.7,4.326
